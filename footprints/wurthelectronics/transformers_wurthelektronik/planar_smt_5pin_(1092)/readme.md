...
| number of pads | 5 | 
| github path | http://github.com/WurthElectronics/Transformers_WurthElektronik.pretty/blob/master/tmp/data//oomlout_oomp_footprint_src/PLANAR_SMT_5PIN_(1092).kicad_mod | 
| oomp key | oomp_wurthelectronics_transformers_wurthelektronik_planar_smt_5pin_(1092) | 
| oomp bot github | https://github.com/oomlout/oomlout_oomp_footprint_bot/tree/main/tmp/data//oomlout_oomp_footprint_src/footprints/wurthelectronics_transformers_wurthelektronik_planar_smt_5pin_(1092)/working | 
## Images  
